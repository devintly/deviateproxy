...
(function (root) {
  const MESSAGES = {
    ru: {
      ...
      host_access_title: "Нужен доступ к сайтам",
      host_access_desc: "Без доступа ко всем сайтам прокси, авторизация и загрузка списков не работают.",
      btn_grant_access: "Разрешить",
      msg_host_access_denied: "Доступ к сайтам не выдан",
    ...
    en: {
      ...
      host_access_title: "Website access required",
      host_access_desc: "Proxying, authentication, and list updates need access to all websites.",
      btn_grant_access: "Allow access",
      msg_host_access_denied: "Website access was not granted",
